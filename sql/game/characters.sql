CREATE TABLE IF NOT EXISTS `characters` (
  ...
  `visual_classid` int(3) DEFAULT NULL,
  `visual_effectid` int(3) DEFAULT NULL,
  `weapornid` int(11) DEFAULT NULL,
  `chestid` int(11) DEFAULT NULL,
  `legid` int(11) DEFAULT NULL,
  `gloveid` int(11) DEFAULT NULL,
  `feetid` int(11) DEFAULT NULL,
  `lhandid` int(11) DEFAULT NULL,
  `cloakid` int(11) DEFAULT NULL,
